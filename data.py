...
decastart.add_participation(
    Decathlon(p_abele, Participant("Abele", "Arthur", 1, "GER"))
)
decastart.add_participation(
    Decathlon(p_braun, Participant("Braun", "Pieter", 1, "NED"))
)
...
hepta.add_participation(
    Heptathlon(p_thiam, Participant("Thiam", "Nafissatou", 0, "BEL"))
)
hepta.add_participation(
    Heptathlon(p_ennis_hill, Participant("Ennis-Hill", "Jessica", 0, "GBR"))
)
hepta.add_participation(
    Heptathlon(p_theisen_eaton, Participant("Theisen-Eaton", "Brianne", 0, "CAN"))
)
hepta.add_participation(
    Heptathlon(p_ikauniece, Participant("Ikauniece", "Laura", 0, "LAT"))
)
hepta.add_participation(
    Heptathlon(p_schafer, Participant("Schäfer", "Carolin", 0, "GER"))
)
hepta.add_participation(
    Heptathlon(
        p_johnson_thompson, Participant("Johnson-Thompson", "Katarina", 0, "GBR")
    )
)
hepta.add_participation(
    Heptathlon(p_rodriguez, Participant("Rodríguez", "Yorgelis", 0, "CUB"))
)
hepta.add_participation(
    Heptathlon(p_farkas, Participant("Zsivoczky-Farkas", "Györgyi", 0, "HUN"))
)
...
hepta.add_participation(
    Heptathlon(p_nana_djimou, Participant("Nana Djimou", "Antoinnette", 0, "FRA"))
)
